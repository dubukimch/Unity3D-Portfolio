...
public class Owr_Right_Minion_FSM : MonoBehaviour
{
    ...
    void Walk()
    {
        ...
        {
            Right_target = GameObject.FindWithTag("Right_Zone").transform;

            if (nav.destination != Right_target.transform.position)
            {
                nav.SetDestination(Right_target.transform.position);
            }
            else
            {
