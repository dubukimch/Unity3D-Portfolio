...
public class Owr_Middle_Minion_FSM : MonoBehaviour
{
    ...
    void ForeTop_Set_Value()
    {
        try
        {
            ...
            GameObject[] LeftForetop_count = GameObject.FindGameObjectsWithTag("Enemy_Middle_ForeTop");
            LeftForetop_Count = LeftForetop_count.Length;
            if (LeftForetop_Count >= 1)
            {
                Enemy_ForeTop_target = GameObject.FindWithTag("Enemy_Middle_ForeTop").transform;
    ...
    void Exp_Division_Search()
    {
        for (int i = 0; i < _target.Length; i++)
        {
            ...
            if (_targetTf.tag == "Enemy_Top" && distance < 10f)
            {
                ...
                Enemy_Player_UI_Manager.Instance.Enemy_Top_Coin_Value += 50;
            ...
            if (_targetTf.tag == "Enemy_Bottom" && distance < 10f)
            {
                ...
                Enemy_Player_UI_Manager.Instance.Enemy_Bottom_Coin_Value += 50;
            ...
            if (_targetTf.tag == "Enemy_Middle" && distance < 10f)
            {
                ...
                Enemy_Player_UI_Manager.Instance.Enemy_Middle_Coin_Value += 50;
            ...
            if (_targetTf.tag == "Enemy_Support" && distance < 10f)
            {
                ...
                Enemy_Player_UI_Manager.Instance.Enemy_Support_Coin_Value += 50;
            ...
            if (_targetTf.tag == "Enemy_Jungle" && distance < 10f)
            {
                ...
                Enemy_Player_UI_Manager.Instance.Enemy_Jungle_Coin_Value += 50;
