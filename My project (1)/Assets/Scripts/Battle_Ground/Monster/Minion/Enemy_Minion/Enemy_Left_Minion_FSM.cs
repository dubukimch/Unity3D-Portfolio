...
public class Enemy_Left_Minion_FSM : MonoBehaviour
{
    ...
    void ForeTop_Set_Value()
    {
        try
        {
            ...
            GameObject[] LeftForetop_count = GameObject.FindGameObjectsWithTag("Owr_Left_ForeTop");
            LeftForetop_Count = LeftForetop_count.Length;
            if (LeftForetop_Count >= 1)
            {
                Enemy_ForeTop_target = GameObject.FindWithTag("Owr_Left_ForeTop").transform;
