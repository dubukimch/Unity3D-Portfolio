...
public class Enemy_Right_Minion_FSM : MonoBehaviour
{
    ...
    void ForeTop_Set_Value()
    {
        try
        {
            ...
            GameObject[] LeftForetop_count = GameObject.FindGameObjectsWithTag("Owr_Right_ForeTop");
            LeftForetop_Count = LeftForetop_count.Length;
            if (LeftForetop_Count >= 1)
            {
                Enemy_ForeTop_target = GameObject.FindWithTag("Owr_Right_ForeTop").transform;
    ...
    void Walk()
    {
        ...
        {
            Middle_target = GameObject.FindWithTag("Right_Zone").transform;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == "Right_Zone")
        {
            Middle_Value = true;
