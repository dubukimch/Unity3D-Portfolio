...
public class Albino_Dragon_FSM : MonoBehaviour
{
    ...
    void Initialize_Set_Value()
    {
        if (Monster_Hp_Value < 1f)
        {
            try
            {
                ...
                Albino_Dragon_Monster_Revive_pos = GameObject.Find("Albino_Dragon_Monster_Revive_pos").transform;
    ...
    void Run()
    {
        ...
        if (Attack_distance < 10f && Monster_Hp_Value > 0)
        {
            ani.SetBool("Run", false);
            Albino_Dragon_Monster_State = EnemyState.Attack2;
        }
        if (Monster_Hp_Value <= 0)
        {
            ani.SetBool("Run", false);
            ani.SetBool("Attack", false);
            Albino_Dragon_Monster_State = EnemyState.Die;
        }
    }
    ...
    void Attack2()
    {
        ...
        else if (Attack_distance > 10 && Monster_Hp_Value > 0)
        {
            ani.SetBool("Run", true);
            ani.SetBool("Attack", false);
            Albino_Dragon_Monster_State = EnemyState.Run;
        }
