...
public class Right_Albino_Dragon_FSM : MonoBehaviour
{
    ...
    void Sleep()
    {
        ...
        if (Sleep_Value == false)
        {
            ...
            Monster_Instantiate.Instance.Our_Minion_Dragon_Right_Value = true;
        }
        Die_Count = 1;
    ...
    {
        if (hit.gameObject.layer == LayerMask.NameToLayer("Own_Attack"))
        {
            Monster_Hp_Value -= 0.1f * Time.deltaTime;
        }
    }
