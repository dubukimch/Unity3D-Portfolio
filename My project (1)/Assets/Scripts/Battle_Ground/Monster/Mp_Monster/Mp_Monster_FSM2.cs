...
public class Mp_Monster_FSM2 : MonoBehaviour
{
    ...
    void Set_Value()
    {
        if (Monster_Hp.value < 1f)
        {
            try
            {
                ...
                Hp_Monster_Revive1 = GameObject.Find("Mp_Monster_Revive2_pos").transform;
    ...
    void Die()
    {
        ...
        if (Die_Value == false)
        {
            ani.SetTrigger("Die");
            Die_Value = true;
            Battle_Player_UI_Manager.Instance.Mp_Monster_Kill = true;
        }
    ...
    private void OnControllerColliderHit(ControllerColliderHit hit)
    {
        ...
        {
            Monster_Hp.value -= 0.1f * Time.deltaTime;
        }
    }
}
