...
public class Our_PBRCharacter_AI_FSM : MonoBehaviour
{
    ...
    float Our_PBRCharacter_Hp_Value = 1f;
    float Our_PBRCharacter_Mp_Value = 1f;
    float Our_PBRCharacter_Exp_Value = 0f;
    ...
    void Update()
    {
        if (gameObject.GetComponent<Our_PBRCharacter_AI_FSM>().enabled == true)
        {
            ...
            SearchOurTeam();
            Look_OurTeam_Target();
            if (Our_PBRCharacter_Hp_Value <= 0)
                Die();
            ...
            else if (Attack_Judgment == false)
            {
                ...
                else if (Our_PBRCharacter_Hp_Value >= 1f && Enemy_OurTeam_distance <= 10f) ;
                Attack_Judgment = true;
            }
            ...
            for (int i = 0; i < _target_OurTeam.Length; i++)
            {
               ...
               if (_targetTf_OurTeam.tag == "Our_Player" || _targetTf_OurTeam.tag == "Our" ||
                    ...
                    _targetTf_OurTeam.tag == "Our_Support" || _targetTf_OurTeam.tag == "Our_Bottom" || _targetTf_OurTeam.tag == "Our_Jungle")
                {
                    ...
                    if (Enemy_OurTeam_distance <= 10f && Our_PBRCharacter_Hp_Value > 0.3f)
                    {
                        Attack_Judgment = true;
                    }
                    else if (Enemy_OurTeam_distance > 10f || Our_PBRCharacter_Hp_Value <= 0.3f || _target_OurTeam[i] == null)
                    {
    ...
    {
        Enemy_Top_Player_Hp.fillAmount = Our_PBRCharacter_Hp_Value;
        Enemy_Top_Player_Mp.fillAmount = Our_PBRCharacter_Mp_Value;
        ...
        if (Our_PBRCharacter_Hp_Value >= 1f)
            Our_PBRCharacter_Hp_Value = 1f;
        if (Our_PBRCharacter_Mp_Value >= 1f)
            Our_PBRCharacter_Mp_Value = 1f;
        if (Our_PBRCharacter_Exp_Value >= 1f)
            Our_PBRCharacter_Exp_Value = 1f;
    }
    ...
    void TeamPlayer_Set_Value()
    {
        try
        {
            ...
            GameObject[] TeamPlayer_count = GameObject.FindGameObjectsWithTag("Our");
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.layer == LayerMask.NameToLayer("Monster_Attack"))
        {
            ...
            Our_PBRCharacter_Hp_Value -= 15f * Time.deltaTime;
        ...
        if (other.gameObject.layer == LayerMask.NameToLayer("Enemy_Attack"))
        {
            ...
            Our_PBRCharacter_Hp_Value -= 5f * Time.deltaTime;
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        {
            Our_PBRCharacter_Hp_Value += 3f * Time.deltaTime;
