...
public class Player_RobotKyle : MonoBehaviour
{
    ...
    void Attack()
    {
            ...
            Player_Status.Instance.Player_Skill1_CoolTime_Value <= 0f && Player_Status.Instance.Player_Skill1_Level_Value >= 1 && Enemy_Player_UI_Manager.Instance.Our_Player_Mp > 0f)
        {
            ...
            Enemy_Player_UI_Manager.Instance.Our_RobotKyle_Mp -= 0.1f;
    ...
    {
        if (gameObject.GetComponent<Player_RobotKyle>().enabled == true)
        {
