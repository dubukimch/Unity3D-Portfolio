...
public class Player_SapphiArtchan : MonoBehaviour
{
    ...
    public Transform Right_Foot_Pos;
    public Transform Left_Foot_Pos;
    ...
    void Attack()
    {
        ...
        if ((Input.GetKeyDown(KeyCode.X) || Player_Status.Instance.Skill_Attack1_Value == true) &&
            Player_Status.Instance.Player_Skill1_CoolTime_Value <= 0f && Player_Status.Instance.Player_Skill1_Level_Value >= 1 && Enemy_Player_UI_Manager.Instance.Our_Player_Mp > 0)
        {
            float coolTime = 30f - 6f * Player_Status.Instance.Player_Skill1_Level_Value;

            animator.SetTrigger("Skill1_Attack");
            Enemy_Player_UI_Manager.Instance.Our_SopphiArt_Mp -= 0.1f;
            ...
            StartCoroutine(Skill_Attack1_Continue_Time());
            go_Skill_Attack1 = Instantiate(Skill_Attack1, transform.position, Quaternion.identity);
            Destroy(go_Skill_Attack3, 30f);
        }

        if ((Input.GetKeyDown(KeyCode.C) || Player_Status.Instance.Skill_Attack2_Value == true) &&
            Player_Status.Instance.Player_Skill2_CoolTime_Value <= 0f && Player_Status.Instance.Player_Skill2_Level_Value >= 1 && Enemy_Player_UI_Manager.Instance.Our_Player_Mp > 0)
        {
            ...
            StartCoroutine(Skill_Attack2_Continue_Time());
            go_Skill_Attack2 = Instantiate(Skill_Attack2, transform.position, Quaternion.identity);
            Destroy(go_Skill_Attack2, 30f);
        }

        if ((Input.GetKeyDown(KeyCode.V) || Player_Status.Instance.Skill_Attack3_Value == true) &&
            Player_Status.Instance.Player_Skill3_CoolTime_Value <= 0f && Player_Status.Instance.Player_Skill3_Level_Value >= 1 && Enemy_Player_UI_Manager.Instance.Our_Player_Mp > 0)
        {
    ...
    {
        if (go_Skill_Attack1 != null)
            go_Skill_Attack1.transform.position = transform.position;
        if (go_Skill_Attack2 != null)
            go_Skill_Attack2.transform.position = transform.position;
    ...
    IEnumerator Skill_Attack2_Continue_Time()
    {
        Battle_Player_UI_Manager.Instance.Approach_Attack_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Throw_Attack_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Onehand_Attack_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Twohand_Attack_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Approach_Defence_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Throw_Defence_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Onehand_Defence_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Twohand_Defence_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Approach_Magic_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Throw_Magic_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Onehand_Magic_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Twohand_Magic_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Approach_Speed_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Throw_Speed_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Onehand_Speed_Add_Value += 20;
        Battle_Player_UI_Manager.Instance.Twohand_Speed_Add_Value += 20;
        yield return new WaitForSeconds(30f);
        Battle_Player_UI_Manager.Instance.Approach_Attack_Add_Value -= 20;
        Battle_Player_UI_Manager.Instance.Throw_Attack_Add_Value -= 20;
        Battle_Player_UI_Manager.Instance.Onehand_Attack_Add_Value -= 20;
    ...
    IEnumerator Skill_Attack1_Continue_Time()
    {
        Battle_Player_UI_Manager.Instance.Approach_Attack_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Throw_Attack_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Onehand_Attack_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Twohand_Attack_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Approach_Defence_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Throw_Defence_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Onehand_Defence_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Twohand_Defence_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Approach_Magic_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Throw_Magic_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Onehand_Magic_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Twohand_Magic_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Approach_Speed_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Throw_Speed_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Onehand_Speed_Add_Value += 10;
        Battle_Player_UI_Manager.Instance.Twohand_Speed_Add_Value += 10;
        yield return new WaitForSeconds(30f);
        Battle_Player_UI_Manager.Instance.Approach_Attack_Add_Value -= 10;
        Battle_Player_UI_Manager.Instance.Throw_Attack_Add_Value -= 10;
        Battle_Player_UI_Manager.Instance.Onehand_Attack_Add_Value -= 10;
    ...
    void Attack_Basic_True()
    {
        ...
        SoundManager.Instance.PlaySFXSound("Basic_Attack(Punch & Kick)_Sound", 1f);
    }
    ...
    {
        if (gameObject.GetComponent<Player_SapphiArtchan>().enabled == true)
        {
            if (other.gameObject.layer == LayerMask.NameToLayer("Enemy_Attack"))
            {
                Battle_Player_UI_Manager.Instance.Minion_hit_Judgment = true;
                Enemy_Player_UI_Manager.Instance.Our_SopphiArt_Hp -= 15f * Time.deltaTime;
            }
            ...
            if (other.gameObject.layer == LayerMask.NameToLayer("Monster_Attack"))
            {
                ...
                Enemy_Player_UI_Manager.Instance.Our_SopphiArt_Hp -= 5f * Time.deltaTime;
            }
