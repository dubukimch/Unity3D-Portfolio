...
public class Our_Satomi_AI_FSM : MonoBehaviour
{
    enum EnemyState
    {
        Stance,
    ...
    float Our_Satomi_Hp_Value = 1f;
    float Our_Satomi_Mp_Value = 1f;
    float Our_Satomi_Exp_Value = 0f;
    ...
    void Update()
    {
        ...
        else if (Attack_Judgment == false)
        {
            ...
            else if (Our_Satomi_Hp_Value >= 1f && Enemy_OurTeam_distance <= 10f) ;
            Attack_Judgment = true;
        }
        ...
        try
        {
            ...
            for (int i = 0; i < _target_OurTeam.Length; i++)
            {
                    ...
                    _targetTf_OurTeam.tag == "Our_Support" || _targetTf_OurTeam.tag == "Our_Bottom" || _targetTf_OurTeam.tag == "Our_Jungle")
                {
                    ...
                    if (Enemy_OurTeam_distance <= 10f && Our_Satomi_Hp_Value > 0.3f)
                    {
                        Attack_Judgment = true;
                    }
                    else if (Enemy_OurTeam_distance > 10f || Our_Satomi_Hp_Value <= 0.3f)
                    {
    ...
    void Satomi_Status()
    {
        Enemy_Middle_Player_Hp.fillAmount = Our_Satomi_Hp_Value;
        Enemy_Middle_Player_Mp.fillAmount = Our_Satomi_Mp_Value;
        Enemy_Middle_Player_Exp.fillAmount = Enemy_Player_UI_Manager.Instance.Our_Satomi_Exp;
        Enemy_Middle_Player_Level.text = "" + Enemy_Player_UI_Manager.Instance.Our_Satomi_Level;

        if (Our_Satomi_Hp_Value >= 1f)
            Our_Satomi_Hp_Value = 1f;
        if (Our_Satomi_Mp_Value >= 1f)
            Our_Satomi_Mp_Value = 1f;
        if (Our_Satomi_Exp_Value >= 1f)
            Our_Satomi_Exp_Value = 1f;
    }
    ...
    void TeamPlayer_Set_Value()
    {
        try
        {
            string[] Team_target_Name =
                new string[4] { "Our_Top", "Our_Middle", "Our_Jungle", "Our_Bottom" };
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.layer == LayerMask.NameToLayer("Monster_Attack"))
        {
            ...
            Our_Satomi_Hp_Value -= 15f * Time.deltaTime;
        ...
        if (other.gameObject.layer == LayerMask.NameToLayer("Enemy_Attack"))
        {
            ...
            Our_Satomi_Hp_Value -= 5f * Time.deltaTime;
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        {
            Our_Satomi_Hp_Value += 3f * Time.deltaTime;
