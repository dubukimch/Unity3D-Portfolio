...
public class Enemy_Satomi_AI_FSM : MonoBehaviour
{
    enum EnemyState
    {
        Stance,
    ...
    public GameObject Enemy_Satomi_Player_UI;
    public Image Enemy_Satomi_Player_Hp;
    public Image Enemy_Satomi_Player_Mp;
    public Image Enemy_Satomi_Player_Exp;
    public Text Enemy_Satomi_Player_Level;

    float Enemy_Satomi_Player_Hp_Value = 1f;
    float Enemy_Satomi_Player_Mp_Value = 1f;
    float Enemy_Satomi_Player_Exp_Value = 0f;
    ...
    Transform Bottom_target;
    bool Bottom_Value = false;

    bool Zone_Value = false;
    string Zone_Value_Tag_Name = null;
    ...
    void Start()
    {
        ...
        Satomi_State = EnemyState.Stance;
    ...
    void Update()
    {
        if (gameObject.GetComponent<Enemy_Satomi_AI_FSM>().enabled == true)
        {
            ...
            SearchOurTeam();
            Look_OurTeam_Target();
            if (Enemy_Satomi_Player_Hp_Value <= 0)
                Die();
            ...
            else if (Attack_Judgment == false)
            {
                ...
                else if (Enemy_Satomi_Player_Hp_Value >= 1f)
                    Attack_Judgment = true;
            }
    ...
    private void SearchEnemy()
    {
        ...
        for (int i = 0; i < _target.Length; i++)
        {
            ...
            if (_targetTf.tag != gameObject.tag && (
                _targetTf.tag == "Our" || _targetTf.tag == "Our_Minion_Dragon" || 
        ...
        try
        {
            ...
            for (int i = 0; i < _target_OurTeam.Length; i++)
            {
                ...
                if (_targetTf_OurTeam.tag != gameObject.tag && (
                       _targetTf_OurTeam.tag == "Enemy_Top" || _targetTf_OurTeam.tag == "Enemy_Middle" || _targetTf_OurTeam.tag == "Enemy" || _targetTf_OurTeam.tag == "Enemy_Minion_Dragon" ||
                     _targetTf_OurTeam.tag == "Enemy_Support" || _targetTf_OurTeam.tag == "Enemy_Bottom" || _targetTf_OurTeam.tag == "Enemy_Jungle"))
                {
                    ...
                    if (Enemy_OurTeam_distance <= 30f && Enemy_Satomi_Player_Hp_Value > 0.3f)
                    {
                        Attack_Judgment = true;
                    }
                    else if (Enemy_OurTeam_distance > 30f || Enemy_Satomi_Player_Hp_Value <= 0.3f || _target_OurTeam[i] == null || _target_OurTeam[i].tag == gameObject.tag)
                    {
    ...
    void Arisa_Status()
    {
        Enemy_Satomi_Player_Hp.fillAmount = Enemy_Satomi_Player_Hp_Value;
        Enemy_Satomi_Player_Mp.fillAmount = Enemy_Satomi_Player_Mp_Value;
        Enemy_Satomi_Player_Exp.fillAmount = Enemy_Player_UI_Manager.Instance.Enemy_Bottom_Player_Exp;
        Enemy_Satomi_Player_Level.text = "" + Enemy_Player_UI_Manager.Instance.Enemy_Bottom_Player_Level;

        if (Enemy_Satomi_Player_Hp_Value >= 1f)
            Enemy_Satomi_Player_Hp_Value = 1f;
        if (Enemy_Satomi_Player_Mp_Value >= 1f)
            Enemy_Satomi_Player_Mp_Value = 1f;
        if (Enemy_Satomi_Player_Exp_Value >= 1f)
            Enemy_Satomi_Player_Exp_Value = 1f;
    }
    ...
    void Stance()
    {
        ...
        if (gameObject.tag == "Enemy_Top" || gameObject.tag == "Enemy_Middle" || gameObject.tag == "Enemy_Bottom")
        {
            ...
            if (Enemy_ForeTop_Attack_distance > 3f)
                Satomi_State = EnemyState.Walk;

            else if (Enemy_ForeTop_Attack_distance <= 3f)
                Satomi_State = EnemyState.Attack;
        }
    ...
    void Walk()
    {
        ...
        if (Zone_Value == true)
        {
            ...
            if ((gameObject.tag == "Enemy_Top" || gameObject.tag == "Enemy_Middle" || gameObject.tag == "Enemy_Bottom") && Enemy_OurTeam_distance <= 3f )
            {
                ani.SetBool("Run", true);
            ...
            else if ((gameObject.tag == "Enemy_Top" || gameObject.tag == "Enemy_Middle" || gameObject.tag == "Enemy_Bottom") && Enemy_OurTeam_distance >= 3f)
            {
                ani.SetBool("Run", true);

                Target_Dir = _targetTf_OurTeam;
                Target_Distance = Enemy_OurTeam_distance;
            ...
            if (Target_Distance > 3f && (Enemy_Value == true ||
                (gameObject.tag != "Enemy_Top" && gameObject.tag != "Enemy_Middle" && gameObject.tag != "Enemy_Bottom")))
            {
                ani.SetBool("Run", true);
        ...
        if (Zone_Value == false)
        {
            if (gameObject.tag == "Enemy_Bottom")
            {
                int ForeTop_Count;

                GameObject[] ForeTop_count = GameObject.FindGameObjectsWithTag("Enemy_Left_ForeTop");
                ForeTop_Count = ForeTop_count.Length;
                Debug.Log("ForeTop_count.Length :" + ForeTop_count.Length);
                if (ForeTop_count.Length == 3)
                {
                    ani.SetBool("Run", true);

                    Target_Dir = GameObject.Find("Enemy_Left_Tower (1)").transform;
                    Target_Distance = Vector3.Distance(GameObject.Find("Enemy_Left_Tower (1)").transform.position, transform.position);
                    Zone_Value_Tag_Name = "Enemy_Left_Tower (1)";
                }
                else if (ForeTop_count.Length == 2)
                {
                    ani.SetBool("Run", true);

                    Target_Dir = GameObject.Find("Enemy_Left_Tower (2)").transform;
                    Target_Distance = Vector3.Distance(GameObject.Find("Enemy_Left_Tower (2)").transform.position, transform.position);
                    Zone_Value_Tag_Name = "Enemy_Left_Tower (2)";

                }
                else if (ForeTop_count.Length == 1)
                {
                    ani.SetBool("Run", true);

                    Target_Dir = GameObject.Find("Enemy_Left_Tower (3)").transform;
                    Target_Distance = Vector3.Distance(GameObject.Find("Enemy_Left_Tower (3)").transform.position, transform.position);
                    Zone_Value_Tag_Name = "Enemy_Left_Tower (3)";

                }

                else if (ForeTop_count.Length == 0)
                {
                    ani.SetBool("Run", true);
            ...
            else if ((gameObject.tag == "Enemy_Middle" && Zone_Value == false))
            {
                int ForeTop_Count;

                GameObject[] ForeTop_count = GameObject.FindGameObjectsWithTag("Enemy_Middle_ForeTop");
                ForeTop_Count = ForeTop_count.Length;
                ...
                if (ForeTop_count.Length == 3)
                {
                    ...
                    Target_Dir = GameObject.Find("Enemy_Middle_Tower (1)").transform;
                    Target_Distance = Vector3.Distance(GameObject.Find("Enemy_Middle_Tower (1)").transform.position, transform.position);
                    Zone_Value_Tag_Name = "Enemy_Middle_Tower (1)";
                ...
                else if (ForeTop_count.Length == 2)
                {
                    ...
                    Target_Dir = GameObject.Find("Enemy_Middle_Tower (2)").transform;
                    Target_Distance = Vector3.Distance(GameObject.Find("Enemy_Middle_Tower (2)").transform.position, transform.position);
                    Zone_Value_Tag_Name = "Enemy_Middle_Tower (2)";
                ...
                else if (ForeTop_count.Length == 1)
                {
                    ...
                    Target_Dir = GameObject.Find("Enemy_Middle_Tower (3)").transform;
                    Target_Distance = Vector3.Distance(GameObject.Find("Enemy_Middle_Tower (3)").transform.position, transform.position);
                    Zone_Value_Tag_Name = "Enemy_Middle_Tower (3)";
            ...
            else if ((gameObject.tag == "Enemy_Top" && Zone_Value == false))
            {
                int ForeTop_Count;

                GameObject[] ForeTop_count = GameObject.FindGameObjectsWithTag("Enemy_Right_ForeTop");
                ForeTop_Count = ForeTop_count.Length;
                ...
                if (ForeTop_count.Length == 3)
                {
                    ...
                    Target_Dir = GameObject.Find("Enemy_Right_Tower (1)").transform;
                    Target_Distance = Vector3.Distance(GameObject.Find("Enemy_Right_Tower (1)").transform.position, transform.position);
                    Zone_Value_Tag_Name = "Enemy_Middle_Tower (1)";
                ...
                else if (ForeTop_count.Length == 2)
                {
                    ...
                    Target_Dir = GameObject.Find("Enemy_Right_Tower (2)").transform;
                    Target_Distance = Vector3.Distance(GameObject.Find("Enemy_Right_Tower (2)").transform.position, transform.position);
                    Zone_Value_Tag_Name = "Enemy_Right_Tower (2)";
                ...
                else if (ForeTop_count.Length == 1)
                {
                    ...
                    Target_Dir = GameObject.Find("Enemy_Right_Tower (3)").transform;
                    Target_Distance = Vector3.Distance(GameObject.Find("Enemy_Right_Tower (3)").transform.position, transform.position);
                    Zone_Value_Tag_Name = "Enemy_Right_Tower (3)";
    ...
    private void OnTriggerEnter(Collider other)
        {
            if (gameObject.GetComponent<Enemy_Satomi_AI_FSM>().enabled == true)
            {
                if (other.gameObject.layer == LayerMask.NameToLayer("Monster_Attack"))
                {
                    ...
                    Enemy_Satomi_Player_Hp_Value -= 15f * Time.deltaTime;
                ...
                if (other.gameObject.layer == LayerMask.NameToLayer("Own_Attack"))
                {
                    ...
                    Enemy_Satomi_Player_Hp_Value -= 5f * Time.deltaTime;
        ...
        private void OnCollisionStay(Collision collision)
        {
            if (gameObject.GetComponent<Enemy_Satomi_AI_FSM>().enabled == true)
            {
                ...
                if ((collision.gameObject.tag == "Enemy_Right_ForeTop" && gameObject.name == Zone_Value_Tag_Name) || (collision.gameObject.name == Zone_Value_Tag_Name && gameObject.tag == "Enemy_Middle") || (collision.gameObject.name == Zone_Value_Tag_Name && gameObject.tag == "Enemy_Bottom"))
                {
                    Zone_Value = true;
        ...
        private void OnTriggerStay(Collider other)
        {
            ...
            {
                Enemy_Satomi_Player_Hp_Value += 3f * Time.deltaTime;
                Zone_Value = false;
